...
set c=%c% -gzip "XDMessaging.dll" "Compressed\XDMessaging.dll"
...
set c=%c% -gzip "System.Threading.dll" "Compressed\System.Threading.dll"
...
set c=%c% -gzip "DownloadManager.dll" "Compressed\DownloadManager.dll"
set c=%c% -gzip "Ftp.dll" "Compressed\Ftp.dll"
set c=%c% -gzip "msvcp100.dll" "Compressed\msvcp100.dll"
set c=%c% -gzip "msvcr100.dll" "Compressed\msvcr100.dll"
