...
namespace GRF.Image.Decoders {
	internal static class Adam7
    {
        ...
        public static int GetNumberOfScanlinesInPass(IhdrData header, int pass)
        {
        ...
        public static int GetPixelsPerScanlineInPass(IhdrData header, int pass)
        {
        ...
        public static void GetPixelIndexForScanlineInPass(IhdrData header, int pass, int scanlineIndex, int indexInScanline, out int x, out int y)
        {
	        ...
	        x = precedingCols + columnIndices[actualCol];
	        y = precedingRows + rows[actualRow];
        }
    }
}
