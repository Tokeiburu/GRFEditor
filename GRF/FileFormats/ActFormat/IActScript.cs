namespace GRF.FileFormats.ActFormat {
	public interface IActScript {
		...
		bool CanExecute(Act act, int selectedActionIndex, int selectedFrameIndex, int[] selectedLayerIndexes);
		...
		void Execute(Act act, int selectedActionIndex, int selectedFrameIndex, int[] selectedLayerIndexes);
	}
}